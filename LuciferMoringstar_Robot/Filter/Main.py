    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [[
                ...
                InlineKeyboardButton('😍Click😍', url='https://t.me/share/url?url=https://t.me/cinemazip'),

                InlineKeyboardButton('ഉറവിടം', url="https://t.me/CINEMAZIPLINKS/6")
            ...
            buttons = [
                ...
                [
                    ...
                    InlineKeyboardButton(' ഉറവിടം', url=f'{TUTORIAL}')
